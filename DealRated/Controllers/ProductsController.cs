...
namespace DealRated.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductID,ProductName,Description,Url,FileUpload")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var uploadsRootFolder = Path.Combine(_environment.WebRootPath, "products");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,ProductName,Description,Url,ExtName")] Product product)
        {
